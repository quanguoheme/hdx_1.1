 ...
 * 
 *==========================================================================*/
#ifndef _MML_SCANALOG_H_
#define _MML_SCANALOG_H_

int mml_sc_analog_check(void);
int mml_sc_analog_card_presence(void);
int mml_sc_analog_check_voltage(void);

int mml_sc_analog_power_down(void);
int mml_sc_analog_power_up(int volt);
int mml_sc_analog_card_reset(int value);


#endif /* _MML_SCANALOG_H_ */
