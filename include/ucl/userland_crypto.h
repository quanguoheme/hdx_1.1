...
#define AES_BLOCKLENGTH	(16)
#define DES3_KEYLENGTH	(24)
#define DES_BLOCKLENGTH	(8)
#define DES_KEYLENGTH	(8)
...
int crypto_hw_set_key(const char *algo, const unsigned char *key, int keylen);
int crypto_hw_set_3des_key(const unsigned char *key, int start, int end);
...
int crypto_hw(int op,
	     const unsigned char *bufferIn,
	     unsigned char *bufferOut,
	     int buflen,
	     unsigned char *oiv, int blocklen);
