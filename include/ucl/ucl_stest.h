...
int __API__ ucl_cipher_3des_stest(void);
  ...
  int __API__ ucl_cipher_3des_eee_stest(void);
 ...
 */
  ...
  int __API__ ucl_pkc_dsa_stest(void);

  int __API__ ucl_ecdsa_p224r1_sha1_stest(void);
  int __API__ ucl_ecdsa_p224r1_sha224_stest(void);
  int __API__ ucl_ecdsa_p521r1_sha512_stest(void);
  int __API__ ucl_ecdsa_p384r1_sha384_stest(void);
  int __API__ ucl_ecdsa_p160r1_sha256_stest(void);
  int __API__ ucl_ecdsa_p160r1_sha1_stest(void);
  int __API__ ucl_ecdsa_p192r1_sha1_stest(void);
  int __API__ ucl_ecdsa_p192r1_sha256_stest(void);
  int __API__ ucl_ecdsa_p256r1_sha256_stest(void);
  int __API__ ucl_ecdsa_p256r1_sha1_stest(void);
 ...
 * @ingroup UCL_STEST
 */
int __API__ ucl_hash_sha384_stest(void);
 ...
 * @ingroup UCL_STEST
 */
int __API__ ucl_hash_sha224_stest(void);
 ...
 * @ingroup UCL_STEST
 */
int __API__ ucl_hash_sha512_stest(void);
 ...
 * @retval UCL_ERROR Test failed
 */
int __API__ ucl_hash_sm3_stest(void);
...
int __API__ ucl_hash_ripemd160_stest(void);
  ...
  int __API__ ucl_hmac_sha256_stest(void);
  int __API__ ucl_hmac_sha224_stest(void);
  int __API__ ucl_hmac_sha384_stest(void);
  int __API__ ucl_hmac_sha512_stest(void);
  int __API__ ucl_hmac_sha1_stest(void);
