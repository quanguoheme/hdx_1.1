 ...
 * @ingroup UCL_CBC
 */
int __API__ ucl_3des_eee_cbc(u8 *dataOut, u8 *dataIn, u8 *key, u8 *IV,
...
int __API__ ucl_3des_eee_cbc_init(ucl_3des_ctx_t *ctx, u8 *key, u8 *IV, int mode);
int __API__ ucl_3des_eee_cbc_core(u8 *dataOut, ucl_3des_ctx_t *ctx, u8 *dataIn, u32 byteLen);
int __API__ ucl_3des_eee_cbc_finish(ucl_3des_ctx_t *ctx);

int __API__ ucl_3des_eee_cbc(u8 *dataOut, u8 *dataIn, u8 *key, u8 *IV, u32 byteLen,
                 int mode);
